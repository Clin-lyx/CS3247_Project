...
#include "CardEnchantmentPowerDown.generated.h"
 ...
 */
UCLASS()
class CS3247_PROJECT_API UCardEnchantmentPowerDown : public UCardEnchantment {
	GENERATED_BODY()
...
public:
	...
	virtual UCardEffect* ComposeTo(UCardEffect* Effect, double Multiplier) override;
